  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-20">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <div className="inline-flex items-center px-3.5 py-1.5 rounded-full bg-brand-950/30 text-brand-500 border border-brand-900/50 text-xs font-bold uppercase tracking-wider">
      ...
      <div className="space-y-10">
        <div className="flex items-center gap-3 pb-4 border-b border-matte-800">
          <div className="w-12 h-12 rounded-2xl bg-brand-500 text-white flex items-center justify-center font-bold">
            <Search className="w-6 h-6" />
          </div>
          <div>
            <h2 className="text-2xl font-extrabold text-white">Borrowing Tools & Equipment</h2>
            <p className="text-sm text-slate-400">Save hundreds of dollars and reduce equipment waste by renting locally.</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-matte-900 p-8 rounded-3xl border border-matte-800 shadow-soft space-y-4">
            <span className="w-10 h-10 rounded-xl bg-brand-950/30 border border-brand-900/50 text-brand-500 font-extrabold text-base flex items-center justify-center">01</span>
            <h3 className="text-xl font-bold text-white">Search & Check Availability</h3>
          ...
          <div className="bg-matte-900 p-8 rounded-3xl border border-matte-800 shadow-soft space-y-4">
            <span className="w-10 h-10 rounded-xl bg-brand-950/30 border border-brand-900/50 text-brand-500 font-extrabold text-base flex items-center justify-center">02</span>
            <h3 className="text-xl font-bold text-white">Send a Booking Request</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <div className="bg-matte-900 p-8 rounded-3xl border border-matte-800 shadow-soft space-y-4">
            <span className="w-10 h-10 rounded-xl bg-brand-950/30 border border-brand-900/50 text-brand-500 font-extrabold text-base flex items-center justify-center">03</span>
            <h3 className="text-xl font-bold text-white">Pick Up & Build</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
      ...
      <div className="space-y-10">
        <div className="flex items-center gap-3 pb-4 border-b border-matte-800">
          ...
          <div>
            <h2 className="text-2xl font-extrabold text-white">Lending Out Your Idle Tools</h2>
            <p className="text-sm text-slate-400">Turn your workshop into a reliable stream of passive income.</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-matte-900 p-8 rounded-3xl border border-matte-800 shadow-soft space-y-4">
            <span className="w-10 h-10 rounded-xl bg-amber-950/30 border border-amber-900/50 text-amber-500 font-extrabold text-base flex items-center justify-center">01</span>
            <h3 className="text-xl font-bold text-white">List Your Equipment in 2 Mins</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <div className="bg-matte-900 p-8 rounded-3xl border border-matte-800 shadow-soft space-y-4">
            <span className="w-10 h-10 rounded-xl bg-amber-950/30 border border-amber-900/50 text-amber-500 font-extrabold text-base flex items-center justify-center">02</span>
            <h3 className="text-xl font-bold text-white">Approve on Your Terms</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <div className="bg-matte-900 p-8 rounded-3xl border border-matte-800 shadow-soft space-y-4">
            <span className="w-10 h-10 rounded-xl bg-amber-950/30 border border-amber-900/50 text-amber-500 font-extrabold text-base flex items-center justify-center">03</span>
            <h3 className="text-xl font-bold text-white">Safe & Rewarding</h3>
            <p className="text-sm text-slate-400 leading-relaxed">
      ...
      <div className="bg-matte-950 border border-matte-800 text-white rounded-3xl p-8 sm:p-12 shadow-elevated grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="bg-matte-900 p-8 rounded-2xl border border-matte-800 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            ...
            <button
              ...
              className="btn-secondary py-3 text-sm w-full bg-matte-800 border-matte-700 hover:bg-matte-700 text-slate-200"
            >
              List a Tool
            </button>
          </div>
